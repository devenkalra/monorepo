...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            # Forward: Recreate table with UUID primary key
            sql="""
                ...
                -- Drop old table
                DROP TABLE people_entityrelation;
                
                -- Create new table with UUID primary key
                CREATE TABLE people_entityrelation (
                    id char(32) NOT NULL PRIMARY KEY,
                    from_entity_id char(32) NOT NULL,
                    to_entity_id char(32) NOT NULL,
