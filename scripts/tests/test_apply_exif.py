...
class TestApplyExifKeywords(unittest.TestCase):
    ...
    def test_get_existing_keywords_success(self, mock_run):
        ...
        # exiftool returns JSON with -json flag
        mock_run.return_value = MagicMock(
            returncode=0,
        ...
        self.assertIn('sunset', keywords['XMP-dc:Subject'])
...
class TestApplyExifFileResolution(unittest.TestCase):
    ...
    def test_resolve_files_nonexistent(self):
        ...
        # resolve_files returns the path even if it doesn't exist
        # The actual file existence check happens later in main()
...
class TestApplyExifManualLocation(unittest.TestCase):
    ...
    def test_create_exif_metadata_from_manual_params_gps_only(self):
        ...
        self.assertEqual(metadata['GPSLongitude'], 97.3308)  # Stored as absolute value
        self.assertEqual(metadata['GPSLongitudeRef'], 'W')   # Reference indicates direction
    ...
    def test_create_exif_metadata_from_manual_params_location_only(self):
        ...
        self.assertEqual(metadata['XMP-iptcExt:LocationShownCountryCode'], "US")  # Correct key
